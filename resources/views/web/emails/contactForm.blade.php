        ...
        <tr>
            <td class="body" align="center" valign="top" style="background:#e1e1e1;" width="100%">
                <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td class="header header--left" style="padding: 20px 10px;" align="left">
                                                                <a href="{{ route('home') }}" target="_blank">
                                                                    <img class="header__logo" src="{{ asset('images/reval.png') }}" alt="REVAL" style="display: block; border: 0;" width="175" height="60"></a>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="featured-story__inner" style="background: #fff;">
                                                                <table cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="featured-story__content-inner" style="padding: 32px 30px 30px;">
                                                                            <table cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                        ...
                                                                                        <table cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;" align="left">
                                                                                                    Gracias por comunicarte a con nosotros, atenderemos tu solicitud lo mas pronto posible.<br /><br />
                                                                                                    En <b>REVAL S.A. DE C.V.</b> nos dedicamos a prestar servicios especializados para atenderle en sus requerimientos. Nuestros procesos y productos son de la mejor calidad y nuestra trayectoria es la mejor garantia de nuestra excelencia y confiabilidad, misma que ponemos a disposicion a nivel internacional.
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="featured-story__copy" style="background: #fff;" width="640">
                                                                                        <table cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;" align="left">
                                                                                                    <p>
                                                                                                        ...
                                                                                                        <b>Correo electronico:</b> {{ $data->email }}<br />
                    ...
                    <tr>
                        <td class="footer" width="640" align="center">
                            <table cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 14px; line-height: 18px; color: #738597; padding: 0 20px 40px;">
                                        <br> <br>
                                        Independencia No.5 Sta. Ma. Atarasquillo, Lerma, Edo de Méx. C.P. 52044
                                        <br>
                                        <span>ventas@valvulasreval.mx</span> • <span>728 281 1336</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
